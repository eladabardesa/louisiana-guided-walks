...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-8 sm:py-16 lg:py-20">
        ...
        <div className="mb-16 sm:mb-20 lg:hidden">
          <img
            src="/guitar.png"
        ...
        {/* Pricing note */}
        <section className="mb-16 sm:mb-20 rounded-sm bg-gray-50 p-6">
        ...
        <section className="mb-12 sm:mb-16">
          ...
          {selectedDate && !availability[selectedDate]?.isSoldOut && (
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Ticket quantity */}
              <div>
                <label htmlFor="ticketQuantity" className="block text-sm font-medium text-gray-900 mb-2">
                ...
                <select
                  ...
                  className={`w-full border-b border-gray-300 bg-transparent px-0 py-2 text-base text-gray-900 transition-colors focus:border-gray-900 focus:outline-none ${
                ...
                {errors.ticketQuantity && (
                  <p id="ticketQuantity-error" className="mt-2 text-sm text-red-600" role="alert">
                    {errors.ticketQuantity}
                  </p>
                )}
              </div>
        ...
        <section className="mt-16 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#25D366] rounded-sm hover:bg-[#20BA5A] transition-colors focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#0084FF] rounded-sm hover:bg-[#0066CC] transition-colors focus:outline-none focus:ring-2 focus:ring-[#0084FF] focus:ring-offset-2"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 8.16c-.169 0-.315.12-.355.278-.432 1.698-1.596 3.744-2.293 4.897-.31.52-.9.52-1.21 0-.697-1.153-1.861-3.199-2.293-4.897-.04-.158-.186-.278-.355-.278-.196 0-.355.16-.355.355 0 .81.355 4.065.355 4.065s-.142.284-.355.284c-.213 0-.355-.284-.355-.284S8.16 9.33 8.16 8.52c0-.195-.16-.355-.355-.355-.169 0-.315.12-.355.278-.432 1.698-1.596 3.744-2.293 4.897-.31.52-.9.52-1.21 0-.697-1.153-1.861-3.199-2.293-4.897-.04-.158-.186-.278-.355-.278-.196 0-.355.16-.355.355 0 .81.355 4.065.355 4.065s-.142.284-.355.284c-.213 0-.355-.284-.355-.284S3.16 9.33 3.16 8.52c0-.195-.16-.355-.355-.355-.169 0-.315.12-.355.278C2.018 10.143.854 12.189.157 13.342c-.31.52-.31 1.14 0 1.66.697 1.153 1.861 3.199 2.293 4.897.04.158.186.278.355.278.196 0 .355-.16.355-.355 0-.81-.355-4.065-.355-4.065s.142-.284.355-.284c.213 0 .355.284.355.284s.355-3.255.355-4.065c0-.195.16-.355.355-.355.169 0 .315.12.355.278.432 1.698 1.596 3.744 2.293 4.897.31.52.9.52 1.21 0 .697-1.153 1.861-3.199 2.293-4.897.04-.158.186-.278.355-.278.196 0 .355.16.355.355 0 .81-.355 4.065-.355 4.065s.142.284.355.284c.213 0 .355-.284.355-.284s.355-3.255.355-4.065c0-.195.16-.355.355-.355z"/>
              </svg>
              Messenger
            </a>
            <a
              href={`tel:${CONTACT_PHONE.replace(/\s+/g, '')}`}
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-900 border border-gray-300 rounded-sm hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
            >
