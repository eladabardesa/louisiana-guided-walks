...
export default function AdminPage() {
  ...
  const ADMIN_PASSWORD = 'louisiana2024';
  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-light mb-2 text-gray-900">Submissions</h1>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="text-sm text-gray-600 space-y-1">
                      ...
                      {submission.venue && <p><strong>Venue:</strong> {submission.venue}</p>}
                      {submission.tourType && <p><strong>Type:</strong> {submission.tourType}</p>}
                      <p><strong>Info:</strong> {submission.selectedDate}</p>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-red-600 border border-red-300 hover:bg-red-50 transition-colors self-start"
                  >
                    Delete
                  </button>
                </div>
